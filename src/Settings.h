...
public:
    ...
    // The two points of the automatic brightness curve: "this dark, and I want
    // it this bright" and the same for the bright end. Brightness runs linearly
    // in log(lux) between them, because perception does - see brightnessForLux()
