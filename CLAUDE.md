...
- `web/public/zones.json`, `web/public/*.png`, `docs/panel-preview.png`, `hardware/Qlock250mm/3dprint/panels.scad` — generated by the scripts in [scripts/](scripts/) and committed on purpose, so that neither a build nor a print needs Python. Edit the generator, not the output.
